    ...
    columns: [
        ...
        { data: 'Email' },
        {
            ...
            render: function (data, type, row) {
                ...
                action += `<button type="button" value="${row.Username}" onclick="deleteUser(${row.ID_Role}, this.value)" class="btn btn-sm btn-secondary" title="Delete">
...
function deleteUser(role, nrp) {
    Swal.fire({
        ...
        if (n.value == true) {
            $.ajax({
                url: "/Setting/Delete_User?role=" + role + "&nrp=" + nrp, //URI
                type: "POST",
                success: function (data) {
                    if (data.Remarks == true) {
